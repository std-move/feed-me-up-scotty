...
RSS feeds for sites that provide none, using [CSS selectors](https://developer.mozilla.org/en-US/docs/Learn/CSS/Building_blocks/Selectors).
_Feed me up, Scotty!_ is:

- straightforward to set up.
- runs on GitHub Actions, GitLab CI/CD, or wherever floats your boat.
- uses an actual browser to fetch data, so JavaScript is no problem.
